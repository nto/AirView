...
{
	if (httpHeadersDict == nil)
		httpHeadersDict = [[NSMutableDictionary dictionaryWithObject:value forKey:key] retain];
	else
		[httpHeadersDict setValue:value forKey:key];
}
